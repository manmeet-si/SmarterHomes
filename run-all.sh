java -classpath  SmarterHomes.jar com.assignment2.dos.smarterHomes.GatewayManager test-input.csv &
java -classpath  SmarterHomes.jar com.assignment2.dos.smarterHomes.DatabaseHandler test-input.csv &
